...
#SBATCH -e PSMC3_%j.e.txt
#SBATCH -o PSMC3_%j.log
#SBATCH --mail-user=keith.hernandez@noaa.gov
#SBATCH --mail-type=ALL
#SBATCH -c 20
#SBATCH --mem=80G
#SBATCH -t 3-0
#SBATCH -D /scratch/khernandez/temp2
...
BAMDIR=/home/khernandez/bamtools/z0045928
BAMFILE=Pcra_z0045928_dedup_noRepeats.bam
...
############################################
#PSMC parameters
TEMP_DIR=/scratch/khernandez/temp2
...
MEANDEPTH=${COV} #has to be an integer for min and max calculations below
